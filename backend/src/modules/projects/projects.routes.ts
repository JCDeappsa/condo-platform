...
router.post('/', requireRole('administrator', 'board_member'), validate(createProjectSchema), asyncHandler(projectsController.create));
...
router.patch('/:id', requireRole('administrator', 'board_member'), validate(updateProjectSchema), asyncHandler(projectsController.update));
router.delete('/:id', requireRole('administrator', 'board_member'), asyncHandler(projectsController.delete));
