...
// ── Meter Types (admin) ──
router.post('/types', requireRole('administrator'), validate(createMeterTypeSchema), asyncHandler(metersController.createMeterType));
...
router.patch('/types/:id', requireRole('administrator'), validate(updateMeterTypeSchema), asyncHandler(metersController.updateMeterType));
router.delete('/types/:id', requireRole('administrator'), asyncHandler(metersController.deleteMeterType));

// ── Meter Points (admin) ──
router.post('/points', requireRole('administrator'), validate(createMeterPointSchema), asyncHandler(metersController.createMeterPoint));
...
router.patch('/points/:id', requireRole('administrator'), validate(updateMeterPointSchema), asyncHandler(metersController.updateMeterPoint));
